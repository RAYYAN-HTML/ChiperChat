const backendURL = location.hostname === 'localhost' || location.port ? 'http://localhost:3000' : 'https://your-chat-backend.onrender.com'; // Replace with your production backend URL
